...
import com.wecloud.android.ui.dialog.ConfirmationDialogFragment.ConfirmationDialogFragmentListener;
...
public class RemoveAccountDialogFragment extends ConfirmationDialogFragment
     ...
     */
    public static RemoveAccountDialogFragment newInstance(Account account, Context context) {
        if (account == null ) {
        ...
        SharePreference.setImeiCheck(context,"");
        return frag;
    }
