...
package com.wecloud.android.files.services;
...
import com.wecloud.android.datamodel.UploadsStorageManager;
import com.wecloud.android.db.OCUpload;
import com.wecloud.android.db.PreferenceManager;
import com.wecloud.android.db.UploadResult;
import com.owncloud.android.lib.common.utils.Log_OC;
import com.wecloud.android.utils.ConnectivityUtils;
import com.wecloud.android.utils.Extras;
import com.wecloud.android.utils.PowerUtils;
...
public class TransferRequester {
    ...
    public void uploadNewFiles(
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O && (createdBy == UploadFileOperation.CREATED_AS_CAMERA_UPLOAD_PICTURE ||
                createdBy == UploadFileOperation.CREATED_AS_CAMERA_UPLOAD_VIDEO)) {
    ...
    private void retry(Context context, Account account, OCUpload upload) {
        if (upload != null) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O && (upload.getCreatedBy() ==
                    UploadFileOperation.CREATED_AS_CAMERA_UPLOAD_PICTURE || upload.getCreatedBy() == UploadFileOperation.CREATED_AS_CAMERA_UPLOAD_VIDEO)) {
                // Since in Android O the apps in background are not allowed to start background
                // services and camera uploads feature may try to do it, this is the way to proceed
                context.startForegroundService(intent);
            } else {
    ...
    private int getRequiredNetworkType(Context context, String accountName, String remotePath) {
        ...
        if (ocUpload.getCreatedBy() == UploadFileOperation.CREATED_AS_CAMERA_UPLOAD_PICTURE && !mConfig.isWifiOnlyForPictures() ||
                ocUpload.getCreatedBy() == UploadFileOperation.CREATED_AS_CAMERA_UPLOAD_VIDEO && !mConfig.isWifiOnlyForVideos()) {
